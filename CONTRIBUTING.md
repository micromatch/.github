...
- Star [micromatch projects](https://github.com/micromatch)
...
- **Avoid creating issues for implementation help** - It's much better for discoverability, SEO, and semantics to ask implementation-related questions on [stackoverflow.com][so], so that we can keep the issue tracker focused on bugs and feature requests.
...
- **version**: (required) please note the version of micromatch are you using
